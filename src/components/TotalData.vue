...
onMounted(() => {
  ...
  new CountUp(totalCountTarget.value, props.data.hb).start()
  new CountUp(totalCountTarget.value, props.data.db).start()
  new CountUp(totalCountTarget.value, props.data.hd).start()
  new CountUp(totalCountTarget.value, props.data.zn).start()
  new CountUp(totalCountTarget.value, props.data.xn).start()
  new CountUp(totalCountTarget.value, props.data.xb).start()
})
